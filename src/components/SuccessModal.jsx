  ...
  return (
    <div className="modal-overlay" data-testid="transfer-success-modal">
      <div
        ...
        aria-describedby="transfer-success-description"
      >
        <div className="modal-card__header">
          <h2 id="transfer-success-title">Transfer successful</h2>
        </div>
        <div className="modal-card__body">
          <p id="transfer-success-description">Your payment instruction has been recorded.</p>
        ...
        <div className="modal-card__footer">
          <div className="button-row">
            <button
              id="transfer-success-dashboard-button"
              type="button"
            ...
            <button
              id="transfer-success-another-button"
              type="button"
